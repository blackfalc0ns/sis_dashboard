...
import type { WithdrawalApplication } from "@/types/students/transfers-withdrawals";

interface WithdrawalsTableProps {
  data: WithdrawalApplication[];
}

export default function WithdrawalsTable({ data }: WithdrawalsTableProps) {
      ...
      render: (_: unknown, row: { [key: string]: unknown }) => (
        ...
        >
          <button
            ...
            className="p-1.5 text-gray-600 hover:text-[#036b80] hover:bg-gray-100 rounded transition-colors"
