        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#036b80] bg-opacity-10 flex items-center justify-center">
              <Lock className="w-5 h-5 text-[#036b80]" />
            </div>
            <div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#036b80] focus:border-transparent"
