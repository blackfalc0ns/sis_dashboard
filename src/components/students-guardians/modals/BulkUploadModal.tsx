      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#036b80] bg-opacity-10 flex items-center justify-center">
              <Upload className="w-5 h-5 text-[#036b80]" />
            </div>
            <div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div
              ...
              className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-[#036b80] hover:bg-gray-50 transition-colors"
            >
              <input
                ref={fileInputRef}
                type="file"
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-[#036b80] hover:bg-[#024d5c] text-white rounded-lg font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {uploading ? (
              <>
