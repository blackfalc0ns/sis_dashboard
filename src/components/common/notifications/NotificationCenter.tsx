      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-96 max-h-[600px] bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
            {/* Header */}
            <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-primary to-hover">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {unreadCount > 0 && (
                    <span className="px-2 py-0.5 text-xs font-semibold text-primary bg-white rounded-full">
                      {unreadCount} new
                    </span>
                  )}
                </div>
