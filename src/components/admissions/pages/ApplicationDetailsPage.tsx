...
import ScheduleTestModal from "../modals/ScheduleTestModal";
import ScheduleInterviewModal from "../modals/ScheduleInterviewModal";
import DecisionModal from "../modals/DecisionModal";
import EnrollmentForm from "../forms/EnrollmentForm";
import DetailsTab from "../application-tabs/DetailsTab";
import GuardiansTab from "../application-tabs/GuardiansTab";
import DocumentsTab from "../application-tabs/DocumentsTab";
import TestsTab from "../application-tabs/TestsTab";
import InterviewsTab from "../application-tabs/InterviewsTab";
import TimelineTab from "../application-tabs/TimelineTab";
