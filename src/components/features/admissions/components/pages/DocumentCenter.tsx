        ...
        <div className="flex items-center gap-2">
          {row.status === "missing" ? (
            <button
              ...
              className="flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-primary hover:bg-hover text-white rounded-lg text-xs font-medium transition-colors min-h-[36px]"
            >
