...
export const phoneCountries: PhoneCountry[] = Object.entries(countryDialCodes)
  .map(([code, dialCode]) => ({
    code,
    dialCode,
    flagCode: countryFlagCodeOverrides[code],
    name: countryNameOverrides[code] || countryNameFormatter.of(code) || code,
  }))
