...
import { ActivityLogItem, ActivityType } from "@/features/admissions/types/leads";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 bg-primary hover:bg-hover text-white rounded-lg text-sm font-medium transition-colors"
        >
