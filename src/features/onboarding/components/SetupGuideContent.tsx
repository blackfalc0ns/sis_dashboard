    ...
    organization: {
      ...
      editor: {
        ...
        logoCrop: {
          ...
          adjustments: t("steps.organization.logoCrop.adjustments"),
          brightness: t("steps.organization.logoCrop.brightness"),
          contrast: t("steps.organization.logoCrop.contrast"),
          saturation: t("steps.organization.logoCrop.saturation"),
          filter: t("steps.organization.logoCrop.filter"),
          filterOriginal: t("steps.organization.logoCrop.filterOriginal"),
          filterGrayscale: t("steps.organization.logoCrop.filterGrayscale"),
          filterWarm: t("steps.organization.logoCrop.filterWarm"),
          filterCool: t("steps.organization.logoCrop.filterCool"),
          background: t("steps.organization.logoCrop.background"),
          backgroundTransparent: t("steps.organization.logoCrop.backgroundTransparent"),
          backgroundWhite: t("steps.organization.logoCrop.backgroundWhite"),
          backgroundCustom: t("steps.organization.logoCrop.backgroundCustom"),
          frame: t("steps.organization.logoCrop.frame"),
          frameSquare: t("steps.organization.logoCrop.frameSquare"),
          frameCircle: t("steps.organization.logoCrop.frameCircle"),
          borderColor: t("steps.organization.logoCrop.borderColor"),
          borderWidth: t("steps.organization.logoCrop.borderWidth"),
          reset: t("steps.organization.logoCrop.reset"),
        },
