...
import type { SettingsExportFormat } from "@/features/settings/shared/utils/settingsExport";

interface SettingsExportDatasetOption {
  value: string;
  label: string;
  description?: string;
}

interface SettingsGlobalExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onExport: (format: SettingsExportFormat) => Promise<void> | void;
  title?: string;
  subtitle?: string;
  confirmLabel?: string;
  datasetCount?: number;
  emptyStateMessage?: string;
  datasetOptions?: SettingsExportDatasetOption[];
  selectedDataset?: string;
  onDatasetChange?: (value: string) => void;
}

export default function SettingsGlobalExportModal({
  isOpen,
  onClose,
  onExport,
  title,
  ...
  selectedDataset,
  onDatasetChange,
}: SettingsGlobalExportModalProps) {
  const t = useTranslations("settings.export");
  const [format, setFormat] = useState<SettingsExportFormat>("csv");
