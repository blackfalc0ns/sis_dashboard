...
export default function SettingsBrandingPage() {
  ...
  const copy: SchoolBrandingFormCopy = {
    ...
    logoCrop: {
      title: t("crop_dialog.title"),
      instruction: t("crop_dialog.instruction"),
      zoom: t("crop_dialog.zoom"),
      rotate: t("crop_dialog.rotate"),
      rotation: (degrees) => t("crop_dialog.rotation", { degrees }),
      cancel: tCommon("cancel"),
      confirm: t("crop_dialog.confirm"),
      preparing: t("crop_dialog.preparing"),
      preparationFailed: t("crop_dialog.preparation_failed"),
      adjustments: t("crop_dialog.adjustments"),
      brightness: t("crop_dialog.brightness"),
      contrast: t("crop_dialog.contrast"),
      saturation: t("crop_dialog.saturation"),
      filter: t("crop_dialog.filter"),
      filterOriginal: t("crop_dialog.filter_original"),
      filterGrayscale: t("crop_dialog.filter_grayscale"),
      filterWarm: t("crop_dialog.filter_warm"),
      filterCool: t("crop_dialog.filter_cool"),
      background: t("crop_dialog.background"),
      backgroundTransparent: t("crop_dialog.background_transparent"),
      backgroundWhite: t("crop_dialog.background_white"),
      backgroundCustom: t("crop_dialog.background_custom"),
      frame: t("crop_dialog.frame"),
      frameSquare: t("crop_dialog.frame_square"),
      frameCircle: t("crop_dialog.frame_circle"),
      borderColor: t("crop_dialog.border_color"),
      borderWidth: t("crop_dialog.border_width"),
      reset: t("crop_dialog.reset"),
    },
