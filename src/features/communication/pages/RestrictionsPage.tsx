...
const labels = {
  en: {
    ...
    attachmentUploadDisabled: "Disable attachment upload",
    reactionDisabled: "Disable reactions",
    metadata: "Metadata",
  ...
  ar: {
    ...
    attachmentUploadDisabled: "تعطيل رفع المرفقات",
    reactionDisabled: "تعطيل التفاعلات",
      ...
      {dialogOpen ? (
        <RestrictionFormDialog
          ...
          labels={{
            ...
            attachmentUploadDisabled: t.attachmentUploadDisabled,
            reactionDisabled: t.reactionDisabled,
            reason: t.reason,
            expiresAt: t.expiresAt,
            metadata: t.metadata,
