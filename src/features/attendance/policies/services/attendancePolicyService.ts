  ...
  "year-1-term-1-1": [
    {
      ...
      descriptionAr: "السياسة الافتراضية للحضور على مستوى المدرسة",
      descriptionEn: "Default school-wide attendance policy",
      scopeType: "SCHOOL",
      mode: "DAILY",
    ...
    },
    {
      ...
      yearId: "year-1",
      termId: "term-1-1",
      nameAr: "سياسة يومية مشتقة - الصف الثاني",
      nameEn: "Derived Daily - Grade 2",
