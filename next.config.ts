...
const csp = [
  ...
  "img-src 'self' data: blob: https: https://*.googleapis.com https://*.gstatic.com https://*.google.com https://*.googleusercontent.com http://159.198.45.134:9000",
  "font-src 'self' data: https://fonts.gstatic.com",
  "connect-src 'self' https: wss: data: blob: https://*.googleapis.com https://*.gstatic.com https://*.google.com http://159.198.45.134:9000",
  "media-src 'self' blob:",
